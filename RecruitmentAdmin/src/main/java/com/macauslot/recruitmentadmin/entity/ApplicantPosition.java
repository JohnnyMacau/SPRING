...
public class ApplicantPosition extends BaseEntity<ApplicantPosition> implements Serializable {
    ...
    private Integer informDept;
    private Integer informApplicant;
    ...
    @Basic
    @Column(name = "who_generate", nullable = true)
    public String getWhoGenerate() {
        return whoGenerate;
    }

    public void setWhoGenerate(String whoGenerate) {
        this.whoGenerate = whoGenerate;
    }
    ...
    @Basic
    @Column(name = "inform_dept", columnDefinition = "tinyint")
	public Integer getInformDept() {
		return informDept;
	}

	public void setInformDept(Integer informDept) {
		this.informDept = informDept;
	}

    @Basic
    @Column(name = "inform_applicant", columnDefinition = "tinyint")
	public Integer getInformApplicant() {
		return informApplicant;
	}

	public void setInformApplicant(Integer informApplicant) {
		this.informApplicant = informApplicant;
	}
    ...
    @Basic
    @Column(name = "interview_time", nullable = true, length = 20)
    ...
    @Basic
    @Column(name = "meeting_room_id", nullable = true, length = 20)
