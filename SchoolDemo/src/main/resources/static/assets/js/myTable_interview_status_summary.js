...
var App = function () {
     ...
     * 初始化DataTables
    * */
    let handlerInitDataTables = function (id, url, sidx, sord, aoColumnDefs) {
        /* let aoColumnDefs = [
    ...
    return {
        //初始化DataTables
        initDataTables: function (id, url, sidx, sord, aoColumnDefs) {
            let handlerInitDataTables1 = handlerInitDataTables(id, url, sidx, sord, aoColumnDefs);
            setRowEvent();
