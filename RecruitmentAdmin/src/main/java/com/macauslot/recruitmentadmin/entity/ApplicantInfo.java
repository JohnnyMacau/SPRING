...
public class ApplicantInfo extends BaseEntity<ApplicantInfo> implements Serializable {
    private static final long serialVersionUID = 333461995330586711L;
    @NotNull(groups = {Update.class}, message = "applicantInfoId is null")
...
//    private String mobile_2;
    ...
    @Basic
    @Column(name = "blacklisted", nullable = false, columnDefinition = "tinyint")
...
/*    public void copy(ApplicantInfo applicantInfo) {
    ...
    public void update(ApplicantInfo applicantInfo) {
        BeanCopyUtil.beanCopyExceptNullWithIngore(applicantInfo, this, "applicantInfoId"
//                , "enFName", "enLName", "cnFName", "cnLName", "userName", "idTypeId", "idCardNumber", "emailAddress"
        );
    }
}
