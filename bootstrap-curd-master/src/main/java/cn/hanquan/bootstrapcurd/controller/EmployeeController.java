...
import cn.hanquan.bootstrapcurd.mapper.EmployeeMapper;
...
public class EmployeeController {
    ...
    public String toAddPage(Model model) {
        ...
        Collection<Department> departments = departmentMapper.getDept();
    ...
    public String addEmp(Employee employee) {
        //来到员工列表页面
        System.out.println("PostMapping 添加的员工信息：" + employee);
        //保存员工
    ...
    public String updateEmployee(Employee employee) {
        System.out.println("PutMapping 修改的员工数据：" + employee);
