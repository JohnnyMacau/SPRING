...
public class ApplicantSourceDetail extends BaseEntity<ApplicantSourceDetail> implements Serializable {

    private static final long serialVersionUID = -4519656353607072142L;
    private Integer id;
    @NotNull(groups = {Create.class}, message = "messageId is null")
    private Integer messageId;
    @NotNull(groups = {Create.class}, message = "orderNum is null")
    private Integer orderNum;
    @NotBlank(groups = {Create.class}, message = "chnDesc is null")
    ...
    @Override
    public void update(ApplicantSourceDetail applicantSourceDetail) {
        BeanCopyUtil.beanCopyExceptNullWithIngore(applicantSourceDetail, this, "id", "messageId","chnDesc");
    }
}
