...
public class LoggingAspect {
    ...
    @Before(value = "execution(* com.school.repository.*.*(..))")
    ...
    @Around(value = "execution(* com.school.repository.*.*(..))")
    ...
    @Before(value = "execution(* com.school.controller.*.*(..))")
    ...
    @Around(value = "execution(* com.school.controller.*.*(..))")
    ...
    @After(value = "execution(* com.school.controller.*.*(..))")
    ...
    @AfterReturning(value = "execution(* com.school.controller.*.*(..))", returning = "returnValue")
